...
:global(
    .journal-left-sidebar.open
        + .journal-page:not(.PageType-RichText):not(.PageType-Spreadsheet):not(.PageType-SpreadsheetV2):not(.PageType-DrawIO):not(.PageType-Excalidraw):not(.PageType-MiniApp):not(.PageType-Kanban)
) {
    padding-left: 2em;
}

:global(
    .journal-left-sidebar:not(.open) + .journal-page:not(.PageType-RichText):not(.PageType-Spreadsheet):not(.PageType-SpreadsheetV2):not(.PageType-DrawIO):not(.PageType-Excalidraw):not(.PageType-MiniApp):not(.PageType-Kanban)
) {
    padding-left: 2rem;
}
